...
from anthro_ai import get_anthropic_synopsis  # Updated import
...
async def post_index(request: Request, gstin: str = Form(...)):
    ...
    # Fetch Anthropic synopsis (Claude)
    ai_narrative = await run_in_threadpool(get_anthropic_synopsis, {**raw_data, "compliance": compliance})
